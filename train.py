...
def parse_arg():
    ...
    parser.add_argument('--output-vector-dim', default=25, type=int, help="dim of output signals")
...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        train_loss, rec_loss, kld_loss = train(model, train_loader, optimizer, scheduler, criterion)
