...
if __name__ == "__main__":
    ...
    video_path = '/NAS_REMOTE/luocheng/Datasets/SL/Video_files/NoXI/001_2016-03-17_Paris/Expert_video/1.mp4'
    audio_path = '/NAS_REMOTE/luocheng/Datasets/SL/Audio_files/NoXI/001_2016-03-17_Paris/Expert_video/1.wav'

    listener_video_clip, fps, n_frames = extract_video_features(video_path, transform)

    print(listener_video_clip.shape)

    listener_audio_clip = extract_audio_features(audio_path, fps, n_frames)
